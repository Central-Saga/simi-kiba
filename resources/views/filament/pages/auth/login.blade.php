<div class="flex min-h-screen">
    ...
    <div class="hidden lg:flex lg:w-3/5 relative overflow-hidden bg-zinc-900">
        ...
        <img src="https://images.unsplash.com/photo-1586769852044-692d6e3703f0?q=80&w=2000&auto=format&fit=crop" 
             alt="Inventory Visual" 
             class="absolute inset-0 h-full w-full object-cover opacity-40">

        <!-- Content -->
        <div class="relative z-20 flex flex-col justify-between p-16 h-full text-white">
            <div class="flex items-center gap-4">
                <div class="flex h-14 w-14 items-center justify-center rounded-2xl bg-white/10 backdrop-blur-2xl border border-white/20 shadow-2xl">
                ...
                <div class="flex flex-col">
                    ...
                    <span class="text-xs font-medium tracking-[0.3em] text-amber-400 uppercase leading-none mt-1">Management System</span>
                </div>
            </div>
            
            <div class="max-w-2xl">
                <div class="inline-flex items-center px-3 py-1 rounded-full bg-amber-500/20 border border-amber-500/30 text-amber-400 text-xs font-bold uppercase tracking-widest mb-6">
                    Sistem Informasi Manajemen Inventaris
                </div>
                <h1 class="text-7xl font-black leading-[0.9] mb-8 tracking-tighter">
                    KOMISI<br>
                    INFORMASI<br>
                    <span class="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-amber-600 italic">BALI</span>
                </h1>
                <p class="text-xl text-zinc-400 leading-relaxed max-w-lg">
                    Platform terintegrasi untuk pengelolaan aset dan inventaris negara dengan presisi, transparansi, dan efisiensi tingkat tinggi.
                </p>
            </div>
    ...
    <div class="w-full lg:w-2/5 flex items-center justify-center p-8 sm:p-16 bg-white dark:bg-zinc-950">
        <div class="w-full max-w-sm">
            ...
            <div class="mb-12">
                ...
                <p class="text-zinc-500 dark:text-zinc-400">Silakan masukkan kredensial Anda untuk mengakses panel kontrol.</p>
            </div>
