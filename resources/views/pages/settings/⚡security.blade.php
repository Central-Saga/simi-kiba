...
new #[Title('Pengaturan keamanan')] class extends Component {
    ...
    public function updatePassword(): void
    {
        ...
        Flux::toast(variant: 'success', text: __('Kata sandi diperbarui.'));
    }
            ...
            <section class="mt-12">
                ...
                <div class="flex flex-col w-full mx-auto space-y-6 text-sm" wire:cloak>
                    @if ($twoFactorEnabled)
                        <div class="space-y-4">
                            <flux:text>
                                {{ __('Anda akan dimintai PIN acak yang aman saat masuk, yang dapat Anda peroleh dari aplikasi pendukung TOTP di ponsel Anda.') }}
                            </flux:text>
                    ...
                    @else
                        <div class="space-y-4">
                            <flux:text variant="subtle">
                                {{ __('Saat Anda mengaktifkan autentikasi dua faktor, Anda akan dimintai PIN saat masuk. PIN ini dapat diperoleh dari aplikasi pendukung TOTP di ponsel Anda.') }}
                            </flux:text>
